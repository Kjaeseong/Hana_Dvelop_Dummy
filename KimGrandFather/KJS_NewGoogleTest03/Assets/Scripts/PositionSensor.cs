...
public class PositionSensor : MonoBehaviour 
{
    ...
    {
        _map.transform.rotation = Quaternion.Euler(0f, _map.transform.rotation.eulerAngles.y + 1f, 0f);
    }
    public void SetMapDown()
    {
        _map.transform.rotation = Quaternion.Euler(0f, _map.transform.rotation.eulerAngles.y - 1f, 0f);
    }

    public void SetMapRotate()
    {
        _map.transform.rotation = Quaternion.Euler(0f, -1 * (float)GetAzimuth(), 0f);
    }
    ...
    private void AzimuthSet()
    {
        ...
        DebugLog(_pose.Heading.ToString());
    }
